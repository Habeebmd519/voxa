...
// // ─────────────────────────────────────────────────────────────
// //  FollowButton — drop-in widget with buildFollow factory
// //  Usage:
// //    FollowButton(onChanged: (isFollowing) { ... })
// //    FollowButton.buildFollow(context, onChanged: (v) { ... })
// // ─────────────────────────────────────────────────────────────
...
//             // ── Variant 1: default pill ──────────────────
//             FollowButton(onChanged: (v) {}),
//             const SizedBox(height: 24),

//             // ── Variant 2: compact icon-only ─────────────
//             FollowButton(compact: true, onChanged: (v) {}),
//             const SizedBox(height: 24),

//             // ── Variant 3: via static buildFollow ────────
//             FollowButton.buildFollow(context, onChanged: (v) {}),
//             const SizedBox(height: 24),

//             // ── Variant 4: starts already following ──────
//             FollowButton(initialFollowing: true, onChanged: (v) {}),
//           ],
//         ),
//       ),
//     );
...
//   /// Factory / static builder — matches the `Widget buildFollow(...)` pattern
//   static Widget buildFollow(
